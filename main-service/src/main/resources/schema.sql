...
ALTER TABLE "compilation_events"
    ADD CONSTRAINT "compilation_events_fk_compilations_id" FOREIGN KEY ("compilation") REFERENCES "compilations" ("id");
ALTER TABLE "compilation_events"
    ADD CONSTRAINT "compilation_events_fk_events_id" FOREIGN KEY ("event") REFERENCES "events" ("id");
